  ...
  const stopListening = () => {
    ...
    return (
        <div className="container">
            ...
            {/* {isListening ? (
                <button onClick={stopListening} className="stop-btn">🛑 Stop Listening</button>
            ) : (
                <button onClick={startListening} className="start-btn">🎙️ Start Speaking</button>
            )} */}
